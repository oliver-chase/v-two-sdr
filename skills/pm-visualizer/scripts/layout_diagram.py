...
def main():
    ...
    current_col_x = START_X + 40
    strategy_start_y = START_Y + 60
    ...
    for title, items, color in cols_data:
        ...
        guide_text['strokeColor'] = "#868e96"
        strategy_elements.extend([t_box, t_txt, guide_text])
        item_y = guide_y + guide_text['height'] + 30
        for item in items:
    ...
    if journey:
        journey_start_y = START_Y + strat_h + 100
